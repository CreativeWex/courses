package examples.predicate.step3;

import examples.predicate.step3.service.TransactionFilter;
import examples.predicate.step3.service.TransactionValidator;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // фильтр 1
    TransactionFilter firstFilter = tr -> tr.getType().equals(TransactionType.E_TRANSFER) && tr.getAmount() <= 10_000;
    ...
    // фильтр 2
    TransactionFilter secondFilter = tr -> !tr.getType().equals(TransactionType.ATM_VSP_PURCHASE) && tr.getAmount() > 150_000;
